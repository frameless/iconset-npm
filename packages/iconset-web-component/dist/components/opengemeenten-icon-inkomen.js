...
const OpengemeentenIconInkomen$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
...
const OpengemeentenIconInkomen = OpengemeentenIconInkomen$1;
const defineCustomElement = defineCustomElement$1;

export { OpengemeentenIconInkomen, defineCustomElement };
