...
const OpengemeentenIconWijkteam$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
...
const OpengemeentenIconWijkteam = OpengemeentenIconWijkteam$1;
const defineCustomElement = defineCustomElement$1;

export { OpengemeentenIconWijkteam, defineCustomElement };
