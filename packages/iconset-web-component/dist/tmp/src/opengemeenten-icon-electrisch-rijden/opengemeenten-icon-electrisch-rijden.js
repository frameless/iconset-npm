...
export class OpengemeentenIconElectrischRijden {
  render() {
    return (h("opengemeenten-icon-container", null,
      h("svg", { fill: "CurrentColor", viewBox: "0 0 48 48", xmlns: "http://www.w3.org/2000/svg" },
        h("path", { d: "M13.49 23.12c-1.38 0-2.5 1.1-2.5 2.46s1.12 2.46 2.5 2.46 2.5-1.1 2.5-2.46-1.12-2.46-2.5-2.46Zm5.5.92h10v2.95h-10z" }),
  ...
  static get is() { return "opengemeenten-icon-electrisch-rijden"; }
