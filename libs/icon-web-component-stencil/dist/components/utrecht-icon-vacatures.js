...
const UtrechtIconVacatures$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
...
}, [1, "utrecht-icon-vacatures"]);
function defineCustomElement$1() {
  if (typeof customElements === "undefined") {
    return;
  }
  const components = ["utrecht-icon-vacatures", "utrecht-icon-container"];
  components.forEach(tagName => { switch (tagName) {
    case "utrecht-icon-vacatures":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, UtrechtIconVacatures$1);
      }
      break;
...
const UtrechtIconVacatures = UtrechtIconVacatures$1;
const defineCustomElement = defineCustomElement$1;

export { UtrechtIconVacatures, defineCustomElement };
