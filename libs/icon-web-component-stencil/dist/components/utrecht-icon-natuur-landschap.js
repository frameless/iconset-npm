...
const UtrechtIconNatuurLandschap$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
...
function defineCustomElement$1() {
  ...
  const components = ["utrecht-icon-natuur-landschap", "utrecht-icon-container"];
  components.forEach(tagName => { switch (tagName) {
    case "utrecht-icon-natuur-landschap":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, UtrechtIconNatuurLandschap$1);
      }
      break;
...
const UtrechtIconNatuurLandschap = UtrechtIconNatuurLandschap$1;
const defineCustomElement = defineCustomElement$1;

export { UtrechtIconNatuurLandschap, defineCustomElement };
