...
const UtrechtIconBijstandsuitkering$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
...
function defineCustomElement$1() {
  ...
  const components = ["utrecht-icon-bijstandsuitkering", "utrecht-icon-container"];
  components.forEach(tagName => { switch (tagName) {
    case "utrecht-icon-bijstandsuitkering":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, UtrechtIconBijstandsuitkering$1);
      }
      break;
...
const UtrechtIconBijstandsuitkering = UtrechtIconBijstandsuitkering$1;
const defineCustomElement = defineCustomElement$1;

export { UtrechtIconBijstandsuitkering, defineCustomElement };
