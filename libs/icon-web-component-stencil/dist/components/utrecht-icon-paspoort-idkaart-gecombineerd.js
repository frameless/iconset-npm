...
const UtrechtIconPaspoortIdkaartGecombineerd$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
...
}, [1, "utrecht-icon-paspoort-idkaart-gecombineerd"]);
function defineCustomElement$1() {
  if (typeof customElements === "undefined") {
    return;
  }
  const components = ["utrecht-icon-paspoort-idkaart-gecombineerd", "utrecht-icon-container"];
  components.forEach(tagName => { switch (tagName) {
    case "utrecht-icon-paspoort-idkaart-gecombineerd":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, UtrechtIconPaspoortIdkaartGecombineerd$1);
      }
      break;
...
const UtrechtIconPaspoortIdkaartGecombineerd = UtrechtIconPaspoortIdkaartGecombineerd$1;
const defineCustomElement = defineCustomElement$1;

export { UtrechtIconPaspoortIdkaartGecombineerd, defineCustomElement };
