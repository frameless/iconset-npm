...
const UtrechtIconWerkzaamheden$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
...
function defineCustomElement$1() {
  ...
  const components = ["utrecht-icon-werkzaamheden", "utrecht-icon-container"];
  components.forEach(tagName => { switch (tagName) {
    case "utrecht-icon-werkzaamheden":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, UtrechtIconWerkzaamheden$1);
      }
      break;
...
const UtrechtIconWerkzaamheden = UtrechtIconWerkzaamheden$1;
const defineCustomElement = defineCustomElement$1;

export { UtrechtIconWerkzaamheden, defineCustomElement };
