...
const UtrechtIconHondenbelasting$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
...
function defineCustomElement$1() {
  ...
  const components = ["utrecht-icon-hondenbelasting", "utrecht-icon-container"];
  components.forEach(tagName => { switch (tagName) {
    case "utrecht-icon-hondenbelasting":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, UtrechtIconHondenbelasting$1);
      }
      break;
...
const UtrechtIconHondenbelasting = UtrechtIconHondenbelasting$1;
const defineCustomElement = defineCustomElement$1;

export { UtrechtIconHondenbelasting, defineCustomElement };
