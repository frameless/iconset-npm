...
const UtrechtIconVeerboot$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
...
const UtrechtIconVeerboot = UtrechtIconVeerboot$1;
const defineCustomElement = defineCustomElement$1;

export { UtrechtIconVeerboot, defineCustomElement };
