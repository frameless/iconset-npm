...
const UtrechtIconHulpmiddelenVinden$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
...
}, [1, "utrecht-icon-hulpmiddelen-vinden"]);
function defineCustomElement$1() {
  if (typeof customElements === "undefined") {
    return;
  }
  const components = ["utrecht-icon-hulpmiddelen-vinden", "utrecht-icon-container"];
  components.forEach(tagName => { switch (tagName) {
    case "utrecht-icon-hulpmiddelen-vinden":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, UtrechtIconHulpmiddelenVinden$1);
      }
      break;
...
const UtrechtIconHulpmiddelenVinden = UtrechtIconHulpmiddelenVinden$1;
const defineCustomElement = defineCustomElement$1;

export { UtrechtIconHulpmiddelenVinden, defineCustomElement };
