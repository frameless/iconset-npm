...
const UtrechtIconMeldingOpenbareRuimte$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
...
function defineCustomElement$1() {
  ...
  const components = ["utrecht-icon-melding-openbare-ruimte", "utrecht-icon-container"];
  components.forEach(tagName => { switch (tagName) {
    case "utrecht-icon-melding-openbare-ruimte":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, UtrechtIconMeldingOpenbareRuimte$1);
      }
      break;
...
const UtrechtIconMeldingOpenbareRuimte = UtrechtIconMeldingOpenbareRuimte$1;
const defineCustomElement = defineCustomElement$1;

export { UtrechtIconMeldingOpenbareRuimte, defineCustomElement };
