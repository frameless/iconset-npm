...
const UtrechtIconLeerlingenvervoer$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
...
const UtrechtIconLeerlingenvervoer = UtrechtIconLeerlingenvervoer$1;
const defineCustomElement = defineCustomElement$1;

export { UtrechtIconLeerlingenvervoer, defineCustomElement };
