...
const UtrechtIconPrijskaartje$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
...
const UtrechtIconPrijskaartje = UtrechtIconPrijskaartje$1;
const defineCustomElement = defineCustomElement$1;

export { UtrechtIconPrijskaartje, defineCustomElement };
