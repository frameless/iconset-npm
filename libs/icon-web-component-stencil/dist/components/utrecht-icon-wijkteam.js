...
const UtrechtIconWijkteam$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
...
function defineCustomElement$1() {
  ...
  const components = ["utrecht-icon-wijkteam", "utrecht-icon-container"];
  components.forEach(tagName => { switch (tagName) {
    case "utrecht-icon-wijkteam":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, UtrechtIconWijkteam$1);
      }
      break;
...
const UtrechtIconWijkteam = UtrechtIconWijkteam$1;
const defineCustomElement = defineCustomElement$1;

export { UtrechtIconWijkteam, defineCustomElement };
