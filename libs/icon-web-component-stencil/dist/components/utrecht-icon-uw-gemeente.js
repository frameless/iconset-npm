...
const UtrechtIconUwGemeente$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
...
function defineCustomElement$1() {
  ...
  const components = ["utrecht-icon-uw-gemeente", "utrecht-icon-container"];
  components.forEach(tagName => { switch (tagName) {
    case "utrecht-icon-uw-gemeente":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, UtrechtIconUwGemeente$1);
      }
      break;
...
const UtrechtIconUwGemeente = UtrechtIconUwGemeente$1;
const defineCustomElement = defineCustomElement$1;

export { UtrechtIconUwGemeente, defineCustomElement };
