    ...
    return (
      <utrecht-icon-container>
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" aria-labelledby={id}>
          {this.iconTitle ? <title id={id}>{this.iconTitle}</title> : <title id={id}>Fiets</title>}
          <path
            fill="currentColor"
          ...
          <path
            fill="currentColor"
            d="M34.24 19h1v-2.48h-1a1.24 1.24 0 1 0 0 2.48zM19 14.25a.75.75 0 0 0-.75-.75H14V15h4.23a.75.75 0 0 0 .77-.75z"
          />
        </svg>
      </utrecht-icon-container>
    );
